...
function useMenu(parameters = {}) {
  ...
  const stateChangeHandler = React35.useCallback((event, field, fieldValue, reason, state) => {
    if (field === "open") {
...
true ? Menu.propTypes = {
   ...
   */
  onOpenChange: import_prop_types15.default.func,
  /**
...
var Option = React44.forwardRef(function Option2(props, forwardedRef) {
...
var Option_default = React44.memo(Option);
...
function useTabsContext() {
  const context = React57.useContext(Context);
  if (context == null) {
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache2, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = React71.useContext(ThemeContext);
      }
      if (typeof props.className === "string") {
      ...
      newProps.className = className;
      newProps.ref = ref;
      return React71.createElement(React71.Fragment, null, React71.createElement(Insertion5, {
        cache: cache2,
        serialized,
        isStringTag: typeof FinalTag === "string"
      }), React71.createElement(FinalTag, newProps));
    });
...
var _excluded39 = ["defaultProps", "mixins", "overrides", "palette", "props", "styleOverrides"];
...
function adaptV4Theme(inputTheme) {
  ...
  const {
    ...
    props = {},
    styleOverrides = {}
  } = inputTheme, other = _objectWithoutPropertiesLoose(inputTheme, _excluded39);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OI7AOZV2.js.map
